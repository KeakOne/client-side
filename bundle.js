...
var xhr=require("xhr"),example=require("./views/homeview.hbs"),app=require("express"),cats=require("./json-cats/routes/cats.js"),tx="b6f6991d03df0e2e04dafffcd6bc418aac66049e2cd74b80f14ac86db1e3f0da",query="https://api.wheretheiss.at/v1/satellites/25544";console.log(example),xhr.get(query,function(e,s){e&&console.log(e),console.log(s.body),document.body.innerHTML=example({name:"fluffy"})}),app.use("/v1/cats",cats),app.use(function(e,s,a){var r=new Error("Not Found");r.status=404,a(r)});
