...
var xhr=require("xhr"),example=require("./views/homeview.hbs"),app=require("express"),tx="b6f6991d03df0e2e04dafffcd6bc418aac66049e2cd74b80f14ac86db1e3f0da",query="https://api.wheretheiss.at/v1/satellites/25544";xhr.get(query,function(e,a){e&&console.log(e),console.log(a.body),document.body.innerHTML=example({name:"fluffy"})}),app.use("/v1/cats",cats),app.use(function(e,a,r){var s=new Error("Not Found");s.status=404,r(s)});
